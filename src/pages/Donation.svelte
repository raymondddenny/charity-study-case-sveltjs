<script>
    ...
    // function for get charity data
    function getCharity(id) {
        // filter the data charity
        return charities.find(function (charity) {
            // use parseInt because we always get string from web
            return charity.id === parseInt(params.id);
        });
    }
...
{#if data}
    <section
        ...
        style="background-image:url('/assets/images/photo-1593113630400-ea4288922497.jpg')">
                    ...
                    <div class="col-lg-6">
                        <div class="xs-donation-form-wraper">
                            ...
                            <form
                                ...
                                <!-- .xs-input-group END -->
                                <div class="xs-input-group">
                                    <label for="xs-donate-charity">List of
                                        Evaluated Charities
                                        <span
                                            class="color-light-red">**</span></label>
                                    <select
