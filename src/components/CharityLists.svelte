<script>
    ...
    function calculateFunded(pledge, target) {
        return Math.round((1 / (target / pledge)) * 100);
    }

    function formatCurrencyNominal(nominal) {
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="xs-popular-item xs-box-shadow">
                                    ...
                                    <div class="xs-skill-track">
                                        <p>
                                            <span
                                                ...
                                                data-value="90"
                                                data-animation-duration="3500">{calculateFunded(charity.pledge, charity.target)}</span>%
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="xs-item-content">
                                ...
                                <a
                                    href="#"
                                    class="xs-post-title xs-mb-30">{charity.title}</a>

                                <ul class="xs-list-with-content">
                                    <li>
                                        {formatCurrencyNominal(charity.pledge)}<span>Pledged</span>
                                    </li>
                                    <li>
                                        <span
                                            class="number-percentage-count number-percentage"
                                    ...
                                    <li>
                                        {calculateDaysRemaining(charity.date_end)}<span>Days
                                            to go</span>
                                    </li>
                                </ul>
                                ...
                                <div class="row xs-margin-0">
                                    <div class="xs-round-avatar">
                                        <img
                                            src={charity.profile_photo}
                                            alt="" />
                                    </div>
                                    <div class="xs-avatar-title">
                                        <a
                                            href="#"><span>By</span>{charity.profile_name}</a>
                                    </div>
                                </div>
